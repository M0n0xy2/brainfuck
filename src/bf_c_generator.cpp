...
bf_c_generator::bf_c_generator(std::string path) : _output_stream(path) {
    _indent_level = 1;
...
bf_c_generator::~bf_c_generator() { _output_stream << "}"; }

bool bf_c_generator::ready() const { return _output_stream.is_open(); }
